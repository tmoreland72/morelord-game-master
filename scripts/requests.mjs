...
export const core = () => {
  ...
  if (!api?.socket?.createChannel || !api.ui?.participation || !api.rolls?.skill) throw new Error("Morelord Game Master requires Morelord Core 0.3.13 or newer and its Socketlib connection.");
  return api;
};
